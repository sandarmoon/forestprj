...
<div class="row adddiv">
	<div class="col-sm-12 mb-4  mb-4">
      <h4 class="font-weight-bold text-dark">Language</h4>
    </div>
    	...
    	<div class="col-lg-10 grid-margin stretch-card mx-auto">
		  	<div class="card">
			    <div class="card-body">
			      ...
			      <div>
			      	<form class="forms-sample" action="{{route('language.store')}}" method="post">
			      		@csrf
	                    <div class="form-group">
	                      <label for="exampleInputUsername1">Name</label>
	                      <input type="text" class="form-control" id="exampleInputUsername1" name="name" placeholder="Language name " value="{{old('name')}}">
	        ...
	        <table class="table" id="datatable">
	          ...
	          <tbody class="index_table">
	            ...
	            <tr>
	              ...
	              <td>
	              	<button class="btn btn-warning btn-sm text-white btn_edit" data-id="{{$language->id}}" data-name="{{$language->name}}"><i class="fa fa-edit"></i></button>
	              	<form action="{{route('language.destroy',$language->id)}}" method="post" class="d-inline-block" onclick="return confirm('Are you sure to delete?')">
	              		@csrf
	              		@method('DELETE')
...
<script type="text/javascript">
	$(document).ready(function(){
	    ...
	    $('.btn_update').click(function(){
	    	...
	    	var route = "{{route('language.update',':id')}}";
