...
<div class="row adddiv">
	<div class="col-sm-12 mb-4  mb-4">
      <h4 class="font-weight-bold text-dark">Browser</h4>
    </div>
    	...
    	<div class="col-lg-10 grid-margin stretch-card mx-auto">
		  	<div class="card">
			    <div class="card-body">
			      ...
			      <div>
			      	<form class="forms-sample" action="{{route('browser.store')}}" method="post">
			      		@csrf
	                    <div class="form-group">
	                      <label for="exampleInputUsername1">Name</label>
	                      <input type="text" class="form-control" id="exampleInputUsername1" name="name" placeholder="Browser name " value="{{old('name')}}">
	        ...
	        <table class="table" id="datatable">
	          ...
	          <tbody class="index_table">
	            ...
	            <tr>
	              ...
	              <td>
	              	<button class="btn btn-warning btn-sm text-white btn_edit" data-id="{{$browser->id}}" data-name="{{$browser->name}}"><i class="fa fa-edit"></i></button>
	              	<form action="{{route('browser.destroy',$browser->id)}}" method="post" class="d-inline-block" onclick="return confirm('Are you sure to delete?')">
	              		@csrf
	              		@method('DELETE')
...
<script type="text/javascript">
	$(document).ready(function(){
	    ...
	    $('.btn_update').click(function(){
	    	...
	    	var route = "{{route('browser.update',':id')}}";
